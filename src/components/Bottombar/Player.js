...
export default function Player() {
  ...
  return (
      <div className='flex justify-between items-center px-4' id='bottombar'>
        <div className='min-w-[11.25rem] w-[30%]ß' id='music_st'>
        {current && (
        ...
        <div className='min-w-[11.25rem] flex items-center justify-end' id='music_sec'>
        <button className='w-8 h-8 flex items-center justify-center text-white text-opacity-70 hover:text-opacity-100'>
            <Icon name="mic" />
        </button>
